...
export const citiesData: CityData[] = [
  ...
  },
  {
    ...
    ar: {
      ...
      metaTitle: "أفضل محامي في بريدة والقصيم | المشيقح للمحاماة - المقر الرئيسي",
      metaDesc: "محامي في بريدة - المقر الرئيسي. 4 تراخيص مهنية: محاماة، أمانة إفلاس، توثيق، تسجيل عيني. ترافع أمام جميع محاكم القصيم. طريق الملك عبدالله، حي الأفق. اتصل 0505149800.",
      heroSubtitle: "المقر الرئيسي للشركة - 4 تراخيص مهنية في خدمتك بقلب القصيم",
      intro: "مدينة بريدة هي المقر الرئيسي لشركة عبدالرحمن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. من موقعنا في طريق الملك عبدالله بحي الأفق، نقدم خدماتنا القانونية الشاملة لعملائنا في منطقة القصيم وجميع مناطق المملكة. نحمل 4 تراخيص مهنية (محاماة، أمانة إفلاس، توثيق، تسجيل عيني) ونفخر بكوننا من أبرز شركات المحاماة في المنطقة بخبرة عائلية تتجاوز 20 عاماً في المجال القانوني. نتعامل مع أكثر من 12 تخصصاً قانونياً ونخدم عملاء من جميع مدن القصيم: عنيزة، الرس، البكيرية، المذنب، البدائع، والأسياح.",
      whyUs: [
        "المقر الرئيسي في بريدة - سهولة الوصول والتواصل المباشر مع المحامي",
        "4 تراخيص مهنية: محاماة (26/129)، أمانة إفلاس (142147)، توثيق، تسجيل عيني",
        ...
        "علاقات مهنية راسخة مع الجهات القضائية والتنفيذية في القصيم",
      ...
      faqs: [
        { q: "أين يقع مكتب المشيقح للمحاماة في بريدة؟", a: "مقرنا الرئيسي في طريق الملك عبدالله، حي الأفق، الدور الثاني، مكتب رقم 1، بريدة 52387. يسهل الوصول إلينا من جميع أحياء بريدة." },
        ...
        { q: "هل أنتم أفضل مكتب محاماة في بريدة؟", a: "نحمل 4 تراخيص مهنية ونقدم 12 خدمة قانونية متخصصة من مقر واحد في بريدة، مع خبرة عائلية تتجاوز 20 عاماً. نترك لعملائنا الحكم على جودة خدماتنا." },
  ...
  },
  {
    ...
    ar: {
      ...
      region: "منطقة حائل",
      title: "محامي في حائل",
      metaTitle: "محامي في حائل | المشيقح للمحاماة - ترافع وإفلاس وتوثيق",
      metaDesc: "محامي متخصص في حائل. ترافع أمام جميع محاكم حائل: تجارية، جنائية، عقارية، عمالية، وإفلاس. قرب جغرافي من القصيم + جلسات عن بعد عبر ناجز. اتصل 0505149800.",
      ...
      whyUs: [
        ...
        "4 تراخيص مهنية: محاماة، أمانة إفلاس، توثيق، تسجيل عيني",
      ],
      services: [
