...
export default function CasesGuide() {
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ليس إلزامياً في جميع الدعاوى، لكن يُنصح بشدة بالاستعانة بمحامٍ متخصص خاصة في الدعاوى التجارية والجزائية وقضايا الإفلاس، لأن اختيار التصنيف الخاطئ أو الطلبات غير المناسبة قد يؤدي لرفض الدعوى أو تأخيرها. تقدم شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس خدمة رفع الدعاوى والتمثيل القانوني في جميع التصنيفات."
          }
        }
      ]
    }
  ...
  return (
    <>
      <SEOHead
        title="دليل الدعاوى القضائية | تصنيفات منصة ناجز"
