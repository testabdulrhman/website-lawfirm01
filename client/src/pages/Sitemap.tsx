  ...
  const sections: SitemapSection[] = lang === "ar" ? [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "إفلاس الشركات في السعودية", href: "/services/bankruptcy/companies" },
        ...
        { label: "تقرير إعلانات الإفلاس — فبراير 2026", href: "/bankruptcy/reports/2026-02" },
        { label: "تقرير إعلانات الإفلاس — مارس 2026", href: "/bankruptcy/reports/2026-03" },
        { label: "تقرير إعلانات الإفلاس — أبريل 2026", href: "/bankruptcy/reports/2026-04" },
        ...
        { label: "إجراء إعادة التنظيم المالي لصغار المدينين", href: "/bankruptcy/procedures/financial-reorganization-small-debtors" },
        { label: "إجراء التصفية", href: "/bankruptcy/procedures/liquidation" },
        { label: "إجراء التصفية لصغار المدينين", href: "/bankruptcy/procedures/liquidation-small-debtors" },
        { label: "إجراء التصفية الإدارية", href: "/bankruptcy/procedures/administrative-liquidation" },
