...
const reviewDocuments = [
  "السجل التجاري وعقد التأسيس وبيانات الملاك والإدارة",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "محامي الإفلاس يقدم المشورة ويمثل الشركة أو الدائن بصفته عميلاً. أما أمين الإفلاس فيُعيّن لإدارة الإجراء بصورة مستقلة وفق النظام وقرار المحكمة. لا يجمع المكتب بين الصفتين في المسألة نفسها عند وجود تعارض.",
  },
  {
          ...
          <div className="grid lg:grid-cols-[1fr_360px] gap-10 lg:gap-16 items-end">
            ...
            <div className="border-r-4 border-[var(--color-gold)] bg-white/5 p-6">
              ...
              <p className="font-body text-sm text-white/60 leading-relaxed">
                لا يُختار الإجراء من اسم المشكلة وحده. التوصية تأتي بعد مراجعة الوقائع والمستندات، ولا تمثل هذه الصفحة رأياً قانونياً في حالة بعينها.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-5 md:px-4 lg:px-8">
          <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-10 lg:gap-16">
            <div>
              ...
              <h2 className="font-display text-2xl md:text-4xl font-bold text-white mb-5">ماذا تحتاج الشركة أن تجهز؟</h2>
