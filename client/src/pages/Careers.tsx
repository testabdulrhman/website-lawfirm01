...
export default function Careers() {
  ...
  useSEO({
    ...
    description:
      "بوابة الانضمام إلى شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. قدّم بياناتك المهنية وسيرتك الذاتية للنظر فيها عند توفر فرصة مناسبة.",
