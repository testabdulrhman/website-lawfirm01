...
export default function Careers() {
  ...
  useSEO({
    title: "انضم إلينا | شركة عبدالرحمن رضوان المشيقح للمحاماة",
    description:
      "بوابة استقبال طلبات الانضمام إلى شركة عبدالرحمن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. قدّم بياناتك المهنية وأرفق سيرتك الذاتية للنظر فيها عند توفر فرصة مناسبة.",
