// ============================================================
// صفحة «انضم إلينا» (/careers) — شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس
...
export default function Careers() {
  ...
  useSEO({
    title: "انضم إلينا | شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس",
    description:
      "بوابة استقبال طلبات الانضمام إلى شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. قدّم بياناتك المهنية وأرفق سيرتك الذاتية للنظر فيها عند توفر فرصة مناسبة.",
        ...
        <div className="container mx-auto px-5 md:px-4 lg:px-8 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-snug mb-5">
              انضم إلى فريق شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس
            </h1>
