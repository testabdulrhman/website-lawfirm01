          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 font-body text-sm md:text-base text-[var(--color-navy)]/70 leading-relaxed">
                {lang === "ar" ? (
                  <>
                    <p>شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس هي منشأة قانونية متخصصة تقدم خدمات التمثيل القانوني والاستشارات للعملاء في جميع المجالات القانونية.</p>
