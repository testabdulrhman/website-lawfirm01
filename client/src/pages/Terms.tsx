...
export default function Terms() {
  ...
  const content = lang === "ar" ? {
    ...
    seoDesc: "الشروط والأحكام لاستخدام موقع شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس",
    seoKeywords: ["الشروط والأحكام", "شروط الاستخدام", "موقع شركة محاماة"],
    home: "الرئيسية",
    ...
    sections: [
      {
        title: "مقدمة",
        content: "مرحباً بك في الموقع الإلكتروني لشركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. باستخدامك لهذا الموقع، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي من هذه الشروط، يرجى عدم استخدام الموقع.",
      },
      {
        title: "طبيعة المحتوى",
      ...
      },
      {
        ...
        content: "جميع المحتويات المنشورة على هذا الموقع، بما في ذلك النصوص والمقالات والشعارات والتصاميم، هي ملكية فكرية لشركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. يُحظر نسخ أو إعادة نشر أي محتوى دون إذن كتابي مسبق.",
      },
      {
    ...
    companyName: "شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس",
