/**
 * حجز موعد — redwan.sa/appointments
 *
...
export default function Appointments() {
  ...
  const seoSchema = useMemo(
    () => [
      ...
      schemas.faqPage([
        {
          question: 'كيف أحجز موعداً مع المكتب؟',
          answer:
            'اختر نوع الخدمة وطريقة الاجتماع ثم اليوم والوقت المتاح، وأدخل بياناتك وأكّد الحجز. يصلك رقم مرجعي فور نجاح الحجز.',
        },
        {
          question: 'هل يمكن عقد الموعد عن بُعد؟',
          answer:
            'نعم، مواعيد أعمال المحاماة وأعمال الإفلاس متاحة عن بُعد أو حضورياً في مقر المكتب ببريدة. التوثيق والتسجيل العيني حضوري فقط. تُرسل تعليمات الاجتماع عن بُعد من المكتب قبل الموعد.',
        },
        {
  ...
  useSEO({
    title: 'حجز موعد',
    description:
      'اختر نوع الخدمة وطريقة الاجتماع والوقت المناسب لإتمام حجز موعد حضوري في مقر المكتب ببريدة أو عن بُعد.',
