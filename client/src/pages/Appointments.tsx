...
export default function Appointments() {
    ...
    () => [
      ...
      schemas.faqPage([
        ...
        },
        {
          ...
          answer:
            'نعم، أغلب الخدمات متاحة عن بُعد أو حضورياً في مقر المكتب ببريدة. تُرسل تعليمات الاجتماع عن بُعد من المكتب قبل الموعد.',
        },
        {
  ...
  useSEO({
    ...
    description:
      'احجز موعد استشارة قانونية مع شركة عبدالرحمن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس — اختر الخدمة وطريقة الاجتماع والوقت المتاح، حضورياً في بريدة أو عن بُعد.',
