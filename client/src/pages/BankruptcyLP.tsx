...
const PHONE_DISPLAY = "920032760";
const PHONE_TEL = "+966920032760";
...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: "كيف أبدأ الآن؟",
    a: "تواصل معنا عبر الهاتف 920032760 أو واتساب. نقيّم وضعك خلال مكالمة أولية، ثم نقترح عليك الإجراء النظامي المناسب لحماية حقوقك وإعادة تنظيم ديونك.",
  },
];
...
export default function BankruptcyLP() {
  useSEO({
    ...
    description:
      "تعثّرت في سداد ديونك؟ نظام الإفلاس السعودي يحميك قانونياً. شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس تساعدك على إيقاف الملاحقات وإعادة تنظيم ديونك. استشارة عبر الهاتف أو واتساب — اتصل: 920032760.",
    keywords:
