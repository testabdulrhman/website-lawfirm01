...
const testimonials = [
  {
    quote: "تعاملت مع شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس في قضية تجارية معقدة، وكانت النتيجة ممتازة. احترافية عالية ومتابعة مستمرة حتى إغلاق الملف.",
    name: "م. خالد العتيبي",
    title: "رجل أعمال",
  },
  {
