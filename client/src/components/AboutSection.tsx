          ...
          >
            ...
            <div className="space-y-6">
              <p className="font-body text-base lg:text-lg text-[var(--color-navy)]/70 leading-relaxed">
                ...
                سعى في شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس إلى توفير حلول قانونية مبتكرة ومخصصة لاحتياجات العملاء، سواء كانوا أفرادًا أو شركات. كما نعمل على حماية حقوق عملائنا وتقديم النصح القانوني لضمان الامتثال للقوانين والتشريعات.
              </p>
              <p className="font-body text-base lg:text-lg text-[var(--color-navy)]/70 leading-relaxed">
